...
#define S_REQCONFIG    0
#define M_REQCONFIG    0xffffU
#define V_REQCONFIG(x) ((x) << S_REQCONFIG)
#define G_REQCONFIG(x) (((x) >> S_REQCONFIG) & M_REQCONFIG)
...
#define S_ZERO_BYTE_CQE_DISABLE    1
#define V_ZERO_BYTE_CQE_DISABLE(x) ((x) << S_ZERO_BYTE_CQE_DISABLE)
#define F_ZERO_BYTE_CQE_DISABLE    V_ZERO_BYTE_CQE_DISABLE(1U)

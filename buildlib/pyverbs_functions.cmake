...
function(build_module_from_cfiles PY_MODULE MODULE_NAME ALL_CFILES LINKER_FLAGS)
  ...
  add_library(${SONAME} MODULE ${ALL_CFILES})
  set_target_properties(${SONAME} PROPERTIES
    ...
    PREFIX "")
  target_link_libraries(${SONAME} LINK_PRIVATE ibverbs rdmacm ${LINKER_FLAGS} ${COMMON_LIBS_PIC} ${CMAKE_THREAD_LIBS_INIT})
  target_include_directories(${SONAME} PRIVATE ${PYTHON_INCLUDE_DIRS})

			      ...
			      enum efa_io_send_op_type op_type)
{
	...
	meta_desc = &qp->sq.curr_tx_wqe->common;
				 ...
				 uint32_t remote_qpn, uint32_t remote_qkey)
{
	...
	tx_wqe->common.dest_qp_num = remote_qpn;
	tx_wqe->common.ah = ah->efa_ah;
	tx_wqe->u.ud.qkey = remote_qkey;
}
